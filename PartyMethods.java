...
public class PartyMethods {
	...
	/*sort method sorts the arraylist with all the people in it by their company number, starting with 1 and ending with 16*/
	public void sort(ArrayList<Person> list) {
		list.sort((o1, o2) //I learned about sorting lists from Mr. Twyford and W3Schools
